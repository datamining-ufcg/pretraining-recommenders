...
class ML100kLeakage(Movielens):
    ...
    def load_item_description(self):
        ...
        return super().load_item_description(path, {'sep': self.items_separator}, adjust_cols=adjust)


class ExplicitML100kLeakage(ML100kLeakage, ExplicitMovielens):
    """

    """

    def __init__(self, **kwargs) -> None:
        self.name = 'ExplicitML100kLeakage'
...
class ImplicitML100kLeakage(ML100kLeakage, ImplicitMovielens):
    """

    """

    def __init__(self, **kwargs) -> None:
        self.name = 'ImplicitML100kLeakage'
        kwargs['name'] = self.name
        super(
